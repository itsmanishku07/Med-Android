...
public final class ItemNotificationBinding implements ViewBinding {
  ...
  private ItemNotificationBinding(@NonNull LinearLayout rootView, @NonNull TextView tvMessage,
  ...
  public static ItemNotificationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemNotificationBinding((LinearLayout) rootView, tvMessage, tvTime, tvTitle);
    }
