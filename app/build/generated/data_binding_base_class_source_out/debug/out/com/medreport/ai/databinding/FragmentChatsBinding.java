...
public final class FragmentChatsBinding implements ViewBinding {
  ...
  private FragmentChatsBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView recyclerView,
  ...
  public static FragmentChatsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentChatsBinding((LinearLayout) rootView, recyclerView, swipeRefresh, tvEmpty);
    }
