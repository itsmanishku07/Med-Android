...
public final class ItemMessageSentBinding implements ViewBinding {
  ...
  private ItemMessageSentBinding(@NonNull FrameLayout rootView, @NonNull ImageView ivImage,
  ...
  public static ItemMessageSentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMessageSentBinding((FrameLayout) rootView, ivImage, tvMessage, tvTime);
    }
